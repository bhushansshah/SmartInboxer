...
class Label(BaseModel):
    ...
    label_name: Optional[str] = Field(None, description="Name of the label")
    ...
    user_id: Optional[str] = Field(None, alias="_user_id", description="ID of the user who created the label")
