...
export default function LabelCard({ label, onEdit, onDelete}) {
        ...
        <div key={label.id} className="p-4 bg-zinc-900 rounded-xl border border-zinc-800 hover:ring-1 hover:ring-purple-600">
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full" style={{ backgroundColor: label.label_color }}></div>
                    <span className="text-white font-medium">{label.label_name}</span>
                </div>
